                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">Mengelola Mata Kuliah</li>
                                <li>
                                    <a href="#">
                                ...
                                <li class="app-sidebar__heading">MENGELOLA UJIAN</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Ujian
                                ...
                                <li class="app-sidebar__heading">Mengelola Peserta</li>
                                <li>
